...
neonatal brain imaging, neonatal MRI, Monte Carlo photon transport, MCX,
iso2mesh, NIRFAST, NIRFASTer, NeuroDOT, inverse problems, ill-posed inverse
problems, Tikhonov regularization, GCV, generalized cross validation,
diffusion posterior sampling, score-based priors, differentiable rendering,
